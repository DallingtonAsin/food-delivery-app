    ...
    return (
        <View className="flex-1">
            ...
            <View style={{ backgroundColor: themeColors.bgColor(0.2) }}
                ...
                <Text className="flex-1 pl-4">Delive in 20-30 minutes</Text>
                <TouchableOpacity>
                        ...
                        return (
                            <View
                                ...
                                <TouchableOpacity
                                    ...
                                    style={{ backgroundColor: themeColors.bgColor(1) }}
                                >
                                    <Icon.Minus strokeWidth={2} height={20} width={20} stroke={colors.white} />
                                </TouchableOpacity>
                            </View>
                        )
                    })
            ...
            <View style={{ backgroundColor: themeColors.bgColor(0.2) }} className="p-6 px-8 rounded-t-3xl space-y-4">
                <View className="flex-row justify-between">
                    ...
                    <Text className="text-gray-700">$150</Text>
                </View>
                <View className="flex-row justify-between">
                    <Text className="text-gray-700">Delivery Fee</Text>
                    <Text className="text-gray-700">$15</Text>
                </View>
                <View className="flex-row justify-between">
                    <Text className="text-gray-700 font-extrabold">Order Total</Text>
                    <Text className="text-gray-700 font-extrabold">$165</Text>
                </View>
                <View>
                    <TouchableOpacity
